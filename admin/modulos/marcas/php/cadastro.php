...
if(isset($_SESSION["DONO"])){
    ...
    if($_SESSION["DONO"] !== $token_usuario){
        ...
        if(!empty($nome)){
            ...
            $busca_marca = mysqli_query($conn, "SELECT id FROM marca WHERE nome = '$nome'");
            if(mysqli_num_rows($busca_marca) > 0){                
                ...
                echo "<script>location.href='../../../marcas-cadastra.php';</script>";
                ...
                $identificador_marca = md5(date('Y-m-d H:i:s').$nome);

                //INSERE NO BANCO
                mysqli_query($conn, "INSERT INTO marca (identificador, nome, logo, cadastrado_por) VALUES ('$identificador_marca','$nome','$nome_imagem_logo','$identificador_usuario_session')");
