...
if(isset($_SESSION["DONO"])){
    ...
    if($_SESSION["DONO"] !== $token_usuario){
        ...
        if(!empty($id) & $nivel_usuario != 'U'){
            ...
            $busca_ordem = mysqli_query($conn, "SELECT ordem, imagem FROM banner_secundario WHERE id = '$id'");
            ...
            unlink("../../../../imagens/banners-secundarios/original/".$banner["imagem"]);
            unlink("../../../../imagens/banners-secundarios/pequena/".$banner["imagem"]);

            //EXCLUI DO BANCO
            mysqli_query($conn, "DELETE FROM banner_secundario WHERE id = '$id'");
