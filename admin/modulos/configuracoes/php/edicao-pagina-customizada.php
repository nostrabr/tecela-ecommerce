...
if(isset($_SESSION["DONO"])){
    ...
    if($_SESSION["DONO"] !== $token_usuario){
        ...
        if(!empty($identificador) & !empty($titulo) & $nivel_usuario != 'U'){
            ...
            mysqli_query($conn, "UPDATE pagina_customizada SET titulo = '$titulo', descricao = '$descricao', palavras_chave = '$palavras_chave', conteudo = '$codigo_fonte_conteudo', mostrar_cabecalho = '$mostrar_cabecalho', mostrar_rodape = '$mostrar_rodape', mostrar_menu_mobile = '$mostrar_menu_mobile', categoria = '$categoria' WHERE identificador = '$identificador'");
