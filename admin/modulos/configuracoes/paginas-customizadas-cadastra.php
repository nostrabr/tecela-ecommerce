...
<section id="configuracoes-paginas-customizadas-cadastra">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8">    
                <div id="admin-titulo-pagina">Páginas customizadas - Cadastro</div>
            </div>
        ...
        <!-- FORM DE CADASTRO -->
        <form id="form-pagina-customizada" action="modulos/configuracoes/php/cadastro-pagina-customizada.php" method="POST">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="palavras-chave" id="palavras-chave" rows="1"></textarea>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea id="summernote11" class="summernote11" name="summernote"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group mb-1 col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" name="mostrar-cabecalho" id="mostrar-cabecalho">
                        <label class="custom-control-label" for="mostrar-cabecalho">Cabeçalho</label>
                    </div>
                </div>
                <div class="form-group mb-1 col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" name="mostrar-rodape" id="mostrar-rodape">
                        <label class="custom-control-label" for="mostrar-rodape">Rodapé</label>
                    </div>
                </div>
                <div class="form-group mb-1 col-12">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" name="mostrar-menu-mobile" id="mostrar-menu-mobile">
