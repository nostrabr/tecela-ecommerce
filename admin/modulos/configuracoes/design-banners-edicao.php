...
if($nivel_usuario == 'U'){
    ...
    $busca_banner = mysqli_query($conn, 'SELECT * FROM banner WHERE identificador = "'.$identificador_banner.'"'); 
...
<section id="banner-edicao">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8">    
                <div id="admin-titulo-pagina">Banners - Edição</div>
            </div>
        ...
        <form enctype="multipart/form-data" action="modulos/configuracoes/php/edicao-banner.php" method="POST">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label for="imagem">Banner desktop (RECOMENDADO 1920x500px)</label>
                        ...
                        <input type="text" name="arquivo" id="arquivo" class="arquivo" placeholder="Selecionar arquivo" readonly="readonly" value="<?= $banner["imagem_desktop"] ?>">
                        <input type="button" id="btn-escolher" class="btn-escolher" value="ESCOLHER" onclick="javascript: inputFileEscolher();">
                    </div>            
                </div>
                <div class="col-6">
                    <div class="form-group">
                        <label for="imagem">Banner mobile (RECOMENDADO 500x700px)</label>
                        ...
                        <input type="text" name="arquivo-mobile" id="arquivo-mobile" class="arquivo-mobile" placeholder="Selecionar arquivo" readonly="readonly" value="<?= $banner["imagem_mobile"] ?>">
