...
<section id="configuracoes-google-analytics">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8">    
                <div id="admin-titulo-pagina">Configuração do Google Merchant Center</div>
            </div>
        ...
        <form action="modulos/configuracoes/php/edicao-google-analytics.php" method="POST">
            <div class="row mt-3">
                <div class="col-12">EM BREVE</div>
            </div>
            <!--
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label for="google-analytics">Código de incorporação <span class="campo-obrigatorio">*</span></label>
                        <textarea type="text" class="form-control" name="google-analytics" id="google-analytics" rows="15"><?= $google_analytics['google_analytics'] ?></textarea>
                        <small>Obs 1: Adicionar o código com as tags html de script.</small>
                        <small>Obs 2: Para remover basta deixar em branco.</small>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
