    ...
    if($_SESSION["DONO"] !== $token_usuario){
        ...
        if(!empty($codigo)){
            ...
            if(mysqli_num_rows($busca_frete_pacote) > 0){
                ...
                $pacote = mysqli_fetch_array($busca_frete_pacote);
                $order_id = $pacote['melhor_envio_id_etiqueta'];
                include '../../frete/melhor-envio/cancelar-etiqueta-verificar.php';  
                ...
                $retorno = array(
                    "error" => "Este pedido ainda não foi processado pelo melhor envio e não pode ser cancelada."
                );
