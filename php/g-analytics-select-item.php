...
if(mb_strlen($session_visitante) == 32){
    ...
    $produto_lista              = filter_input(INPUT_POST,"product_list");
    $produto_lista_id           = filter_input(INPUT_POST,"product_list_id");
    ...
    $retorno_item[] = array(
        ...
        "discount"          => floatval($produto_desconto),
        "index"             => 1,
        ...
        "item_list_id"      => $produto_lista_id,
        "item_list_name"    => $produto_lista,
