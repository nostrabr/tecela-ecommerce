...
if(mysqli_num_rows($busca_produtos_mais_vendidos) > 0){
...
<!--PRODUTOS-->
<section id="produtos" class="produtos-mais-vendidos">
    ...
    <div class="row">
        ...
        while($produto = mysqli_fetch_array($busca_produtos)){ 
            ...
            ?>
            <div id="produto-<?= $produto['produto_id'] ?>" produto="<?= $produto['produto_id'] ?>" class="produto col-12 col-md-6 col-xl-15" nome="<?= $produto['produto_nome'] ?>" relevancia="<?= $produto['produto_relevancia'] ?>" categoria="<?= $produto['produto_categoria_id'] ?>" marca="<?= $produto['produto_marca_id'] ?>" atributos="<?= $produto['produto_atributos'] ?>" caracteristicas="<?= $produto['produto_caracteristicas'] ?>" promocao="<?php if($tem_promocao){ echo '1'; } else { echo '0'; } ?>" preco="<?= $produto_preco_venda_busca ?>" estoque="<?php if($em_estoque){ echo '1'; } else { echo '0'; } ?>">

                <div class="produto-link" onclick="javascript: window.location.href = '<?= $loja['site'] ?>produto/<?= urlProduto($produto['produto_categoria']) ?>/<?= urlProduto($produto['produto_nome']) ?>/<?= $produto['produto_id'] ?>'" data-produto-id="<?= $produto['produto_id'] ?>" data-produto-lista="Mais Vendidos" data-produto-lista-id="produtos-mais-vendidos">
