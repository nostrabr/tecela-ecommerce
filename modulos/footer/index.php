    ...
    <div class="row _container-items-footer text-white">
        ...
        <div class="col-12 col-lg-3 mb-5 mb-lg-0">
            ...
            <div class="d-flex justify-content-start align-items-center mb-3">
                ...
                <p class="text-white _font-item-footer align-self-center my-0"><?= $loja['whatsapp']; ?></p>
            </div>

            <div class="d-flex justify-content-start align-items-center mb-3">
                <img style="width: 30px;" class="mr-3 align-self-center" src='<?= $loja['site']; ?>imagens/phone-orange.png'>
                <div>
                    <p class="text-white _font-item-footer my-2"><?= $loja['telefone']; ?></p>
                    <p class="text-white _font-item-footer my-2">(54) 3332-5522</p>
                    <p class="text-white _font-item-footer my-2">(54) 3332-4525</p>
                </div>
            </div>
...
<div class="bg-white py-4 px-4 px-lg-0" style="margin-left: -15px; margin-right: -15px;">
    <div id="rodape-footer" class="mr-auto ml-auto d-flex justify-content-between align-items-center flex-column flex-lg-row">
        ...
        <a href="https://nostrabr.com/" target="_blank"><img style="width: 80px;" src='<?= $loja['site'] ?>imagens/nostra-logo.png'></a>
    </div>
</div>
