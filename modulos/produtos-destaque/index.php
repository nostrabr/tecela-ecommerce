...
function urlProdutoDestaque($nome){    
    if($nome != ''){
...
function altProdutoDestaque($nome){    
...
<!--CSS-->
<link rel="stylesheet" href="<?= $loja['site'] ?>modulos/produtos-destaque/css/style.css">

<!--PRODUTOS-->
<section id="produtos-destaque">

    <div id="produtos-destaque-produtos">

        <h2 class="d-none">Produtos em destaque</h2>

        <div class="titulo-section">DESTAQUES</div>
        ...
        <div class="row">
            ...
            while($produto = mysqli_fetch_array($busca_produtos)){ 
                ...
                <div class="col-12 col-md-6 col-xl-15">
                    ...
                    <div class="produto-link" onclick="javascript: window.location.href = '<?= $loja['site'] ?>produto/<?= urlProdutoDestaque($produto['produto_categoria']) ?>/<?= urlProdutoDestaque($produto['produto_nome']) ?>/<?= $produto['produto_id'] ?>'" data-produto-id="<?= $produto['produto_id'] ?>" data-produto-lista="Destaques" data-produto-lista-id="produtos-destaque">
