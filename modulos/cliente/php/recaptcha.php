...
$busca_loja = mysqli_query($conn, "SELECT recaptcha_secret, opcao_validar_email_cadastro FROM loja WHERE id = 1");
...
if($response != null && $response->success){
    ...
    echo "<script>location.href='../../../cliente-cadastro';</script>";
