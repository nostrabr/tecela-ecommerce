...
if(!empty($quantidade) & $quantidade > 0 & mb_strlen($identificador) == 32 & mb_strlen($visitante) == 32){
    ...
    if(mysqli_num_rows($busca_produto) > 0){
        ...
        mysqli_query($conn, "UPDATE carrinho_produto SET quantidade = '$quantidade' WHERE identificador = '$identificador'");
